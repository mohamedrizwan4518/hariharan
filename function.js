...
function downloadCV() {
    downloadFile('Documents/HARItendaMhedzisoCV.pdf', 'HARItendaMhedzisoCV.pdf');
...
function openEmail() {
    navigateToSite('mailto:HARImhedziso21@gmail.com');
}
...
function openLinkedIn() {
    navigateToSite('https://www.linkedin.com/in/HARItenda-mhedziso/');
}
...
function showPopUp(message) {
    ...
    switch (message) {
        case 1:
            {
                ...
                cardDescription.textContent = ` Hey! I'm <Passion>, HARI's personalized AI chatbot. Welcome to our portfolio website. Here are some helpful tips while navigating the site. If you know you're ready, feel free to skip this guide.`;
        ...
        case 2:
            {
                ...
                cardDescription.textContent = `HARIHARAN, or HARI for short, is pronounced Tea-no-ten-da. His name translates to "Thank you."`;
        ...
        case 5:
            {
                ...
                cardDescription.textContent = `You're an absolute star! ⭐Get it? because you starred a repo?... listen: blame HARI — he forgot to delete his bad jokes from my database. Anyway, thanks for the support😊! .`;
        ...
        case 8:
            {
                cardTitle.textContent = 'Supporting HARI';
                cardDescription.textContent = `Oh? You want to support HARI? That’s awesome! 😄 He doesn’t take donations, but you can help by offering him a developer job at your company 😉. What ... No company? No problem! A simple follow on GitHub means a lot. Thanks! 💚`;
        ...
        case 9:
            {
                ...
                cardDescription.textContent = `Wait… did you just decline the Terms of Service? 🤨 You do realize that without agreement, you can’t access any of HARI’s amazing creations, right? Well, if that’s your final decision… I’m afraid I have no choice but to escort you out. 👋`;
                cardImage.src = 'Images/Icons/error.svg';
                document
                .getElementById('cardClose')
...
function supportMe() {
    showNotification('Oh, You want to support HARI ...', 8);
}
...
function kickUserOut() {
    ...
    setTimeout(() => {
        window.location.href = 'https://HARItenda-mhedziso.pages.dev/#ban';
    }, 7000);
}
...
// function preload() {
    function downloadCV() {
        const link = document.createElement('a');
        link.href = 'Hari haran resume current.pdf';
...
const stories = {
    professional: [{
        ...
        {
            type: 'video',
            src: 'Images/Portfolio-Trailer.mp4',
            duration: 107000
        }
    ],
    casual: [{
...
window.addEventListener('load', function() {
    ...
    // Set minimum display time to 4 seconds (assuming each GIF loop is 2 seconds)
    setTimeout(() => {
